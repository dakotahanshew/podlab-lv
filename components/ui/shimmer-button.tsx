  ...
  (
    ...
    return (
      <button
        ...
        className={cn(
          "group relative z-0 flex cursor-pointer items-center justify-center overflow-hidden [border-radius:var(--radius)] border border-white/10 px-5 py-2 whitespace-nowrap text-black font-semibold [background:var(--bg)]",
          "transform-gpu transition-transform duration-300 ease-in-out active:translate-y-px",
          "font-display uppercase text-[11px] tracking-wide",
          className,
        )}
        ref={ref}
        {...props}
